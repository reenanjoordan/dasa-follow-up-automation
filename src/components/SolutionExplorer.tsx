  ...
  const steps = [
    {
      ...
      icon: Database,
      color: 'blue',
      description: 'Tickets capturados do Freshworks via webhook em tempo real.',
      details: [
        'Integração com Freshworks API (já utilizado na DASA)',
      ...
      stack: 'Freshworks + Supabase Edge Functions',
    },
    {
      id: 2,
      ...
      stack: 'Vertex AI + GPT-4 + Supabase',
    },
    {
      id: 3,
      ...
      details: [
        'Regras de negócio configuráveis no Supabase',
    ...
    },
    {
      ...
      icon: MessageSquare,
      color: 'green',
      description: 'Mensagens de follow-up enviadas via Teams após 7 dias sem resposta.',
      details: [
        'Microsoft Graph API para envio via Teams',
        'Autenticação via Entra ID (já utilizado)',
        'Até 3 tentativas de contato',
        'Registro de evidências no Freshworks',
      ],
      metrics: { label: 'Taxa de resposta', value: '68%' },
      stack: 'Teams Graph API + Supabase Scheduler',
    },
    {
      id: 5,
      ...
      stack: 'Power BI + Supabase Analytics',
    },
  ];
