  ...
  const steps = [
    {
      ...
      icon: Database,
      color: 'blue',
      description: 'Tickets capturados do ServiceNow TSM via webhook em tempo real.',
      details: [
        'Integração com ServiceNow API (já utilizado na DASA)',
      ...
      stack: 'ServiceNow + Azure Functions',
    },
    {
      id: 2,
    ...
    },
    {
      ...
      icon: Workflow,
      color: 'cyan',
      description: 'Sistema categoriza automaticamente e define o fluxo de tratamento ideal.',
      details: [
        'Regras de negócio configuráveis (workflows visuais)',
        'Roteamento automático por categoria via Logic Apps',
        'Priorização baseada em SLA',
        'Sugestão de analista especializado',
      ],
      metrics: { label: 'Categorias', value: '10+' },
      stack: 'Azure Logic Apps + Azure SQL',
    },
    {
      id: 4,
      ...
      icon: MessageSquare,
      color: 'green',
      description: 'Mensagens de follow-up enviadas via Teams/Twilio após 7 dias sem resposta.',
      details: [
        'Microsoft Graph API para envio via Teams',
        'Twilio para SMS/WhatsApp (já utilizado)',
        'Autenticação via Azure AD (já utilizado)',
        'Até 3 tentativas de contato',
      ],
      metrics: { label: 'Taxa de resposta', value: '68%' },
      stack: 'Teams + Twilio + Azure Logic Apps',
    },
    {
      id: 5,
      ...
      icon: BarChart3,
      color: 'orange',
      description: 'Dashboard em tempo real monitora KPIs, tendências e eficiência do sistema.',
      details: [
        'Dashboards executivos em Power BI (já utilizado)',
